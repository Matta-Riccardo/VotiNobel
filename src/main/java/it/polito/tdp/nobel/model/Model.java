	...
	private void cerca(Set<Esame> parziale, int l, int m) {
		...
		for(Esame e: esami) {
			if(!parziale.contains(e)) {
				...
				parziale.remove(e); // gli passo un oggetto e perchè sono sicuro che lavoprando con un Set tale elemento sarà unico e 
				                    // non ripetuti, lavorassi con una lista questo non funzionerebbe e il backtracking lo dovrei fare 
